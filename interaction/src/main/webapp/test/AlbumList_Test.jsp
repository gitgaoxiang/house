...
<form action="http://192.168.1.249:8001/interaction-service-2.0.0/playTimes" method="get">
 -->
<form action="<c:url value='/interaction?method=userAlbumList'/>" method="post">
<table>
<tr>
<td>beVisitUserId<font color="red">*</font></td>
<td><input id="beVisitUserId" name="beVisitUserId" type="text" value="1158" /></td>
</tr>

<tr>
<td>visitUserId</td>
<td><input id="visitUserId" name="visitUserId" type="text" value="" /></td>
</tr>
