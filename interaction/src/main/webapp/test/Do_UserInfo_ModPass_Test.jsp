...
<body>
修改密码：<br/>
<form action='<c:url value="/interaction?method=passwordModify" />' method="post">
	<table>
	<tr>
		<td>用户名：</td><td><input type="text" name="username" value="18855173460"/><font color="red">*</font></td>
	</tr>
	<tr>
		<td>密    码：</td><td><input type="password" name="password" value="123456"/><font color="red">*</font></td>
	</tr>
	<tr>
		<td>新密码：</td><td><input type="newPassword" name="newPassword" value="1234567"/><font color="red">*</font></td>
	</tr>
	<tr>
