...
<form id="editRoleForm" method="post" action="admin/role/modifyRole.do" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone)">
			...
			<dl>
				...
				<dd>
					<input name="roleName" value="${role.roleName}" type="text" class="required normal" size="25"
						maxlength="20" remote="admin/role/checkUnique.do?roleId=${role.roleId}" />
				</dd>
			</dl>
			<%-- <dl>
				<dt>角色类别：</dt>
					...
					<div id="null_B" class="button">
						<div class="buttonContent">
							<button type="button" name="common.button.submit"
								onclick="submitRoleEditForm()">提 交</button>
						</div>
					</div>
				</li>
				<li>
